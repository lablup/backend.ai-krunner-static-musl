ARG ARCH=x86_64
FROM --platform=linux/${ARCH} lablup/backendai-krunner-wheels:static-musl AS wheels

ARG ARCH=x86_64
FROM --platform=linux/${ARCH} lablup/backendai-krunner-python:static-musl
